package com.hibernate.start.manyToMany.relation.hibernate;
...
public class App 
{
    public static void main( String[] args )
    {
    	...
    	Student s1 = new Student(1, "Rajendra", laptop);
    	Student s2 = new Student(2, "Kumar", laptop1);
    	Student s3 = new Student(3, "Mallina", laptop2);
